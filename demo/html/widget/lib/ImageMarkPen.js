    ...
    */
    ...
    var debug = {
        log: function log(message) {
            if (ImageMarkPen.opt.debug === true) console.log(message);
        },
        warn: function warn(message) {
            if (ImageMarkPen.opt.debug === true) console.warn(message);
        },
        error: function error(message) {
            if (ImageMarkPen.opt.debug === true) console.error(message);
        },
        debug: function debug(message) {
            if (ImageMarkPen.opt.debug === true) console.debug(message);
        }
    };
