...
function LayerShow_2_5_4() {
    ...
    return {
        ...
        button_changeHighLight: function button_changeHighLight(button, hl) {
            ...
            if (button.find("path").length > 0) button.find("path").css("fill", color);
            else button.css({
                "border-color": color,
                "color": color
            });
                ...
                switch (_this.action) {
                    ...
                    case "circle":
                        ...
                        _this.dom_image.unbind("mouseover").on("mousemove", function(e) {
                            ...
                            _debug.debug('\n                                \n1563 moved=' + moved + '\n                            ');
                            if (moved === true) _this.canvas_undo.apply(_this);
                            else moved = true;
                    ...
                    case "drag":
                        ...
                        _this.dom_image.unbind("mousemove").on("mousemove", function(e) {
                            ...
                            if (drag_PosDiff_max.x <= 0) drag_PosDiff.x = 0;
                            else if (drag_PosDiff.x > 0 && _this.drag_translate.x + drag_PosDiff.x > drag_PosDiff_max.x) drag_PosDiff.x = drag_PosDiff_max.x - _this.drag_translate.x;
                            else if (drag_PosDiff.x < 0 && -1 * (_this.drag_translate.x + drag_PosDiff.x) > drag_PosDiff_max.x) drag_PosDiff.x = -_this.drag_translate.x - drag_PosDiff_max.x;

                            if (drag_PosDiff_max.y <= 0) drag_PosDiff.y = 0;
                            else if (drag_PosDiff.y > 0 && _this.drag_translate.y + drag_PosDiff.y > drag_PosDiff_max.y) drag_PosDiff.y = drag_PosDiff_max.y - _this.drag_translate.y;
                            else if (drag_PosDiff.y < 0 && -1 * (_this.drag_translate.y + drag_PosDiff.y) > drag_PosDiff_max.y) drag_PosDiff.y = -_this.drag_translate.y - drag_PosDiff_max.y;
