...
(function() {
    ...
    let ImageMarkPen = {
        ...
        show: (opt) => {
            ...
            if (isIE678()) {
                debug.error(`36: isIE678()`);
                return;
            }
            if (isIE())
                includeCSS("/inc/jquery-ui.min.css");
    ...
    */
    function LayerShow_2_5_4() {
        ...
        return {
            ...
            create_dom: function() {
                ...
                // 字符输入框
                _this.dom_char_input = $(document.createElement("textarea"))
            ...
            canvas_draw: function(ctx, act, params) {
                ...
                switch (act) {
                    ...
                    `);
                        ...
                        if (str_len > 0)
                            ctx.fillText(params.text.substring(substring_s), params.x, y);
            ...
            resize: function() {
                ...
                var resize_doms = function() {
                    ...
                    if (_this.img_obj) {
                        ...
                        debug.debug(` img_width=${img_size.img_width}; img_height=${img_size.img_height}`);
                        ...
                        if (_this.dom_image.css("width") == "0px")
                            _this.dom_image.css({
                    ...
                    switch (_this.action) {
                        ...
                        `);
                            ...
                            `);
                                ...
                                _this.dom_char_input.attr("autofocus", "autofocus").attr("rows", 1)
                                    .css({
                                        // "display": "none",
                                        // "resize": "both",
                                        "width": `${100*zoom_ratio}px`,
                                    ...
                                    `);
                                        ...
                                        debug.debug(_this.ctx.measureText(_this.dom_char_input.val()));
                                        if ($(this).val() !== "")
    ...
    const debug = {
        log: (message) => {
            if (ImageMarkPen.opt.debug === true)
                console.log(message);
        },
        warn: (message) => {
            if (ImageMarkPen.opt.debug === true)
